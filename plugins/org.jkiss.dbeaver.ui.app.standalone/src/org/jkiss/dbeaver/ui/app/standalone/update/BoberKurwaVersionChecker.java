 ...
 * Version checker job
 */
public class BoberKurwaVersionChecker extends AbstractJob {

    private static final Log log = Log.getLog(BoberKurwaVersionChecker.class);
    ...
    public BoberKurwaVersionChecker(boolean force)
    {
        super("BoberKurwa new version release checker");
    ...
    protected IStatus run(DBRProgressMonitor monitor)
    {
        ...
        if (!showUpdateDialog) {
            ...
            showUpdateDialog = DBWorkbench.getPlatform().getPreferenceStore().getBoolean(BoberKurwaPreferences.UI_AUTO_UPDATE_CHECK);
            if (showUpdateDialog) {

                long lastVersionCheckTime = DBWorkbench.getPlatform().getPreferenceStore().getLong(BoberKurwaPreferences.UI_UPDATE_CHECK_TIME);
        ...
        DBWorkbench.getPlatform().getPreferenceStore().setValue(BoberKurwaPreferences.UI_UPDATE_CHECK_TIME, System.currentTimeMillis());
    ...
    {
        UIUtils.asyncExec(() -> {
            BoberKurwaApplication.getInstance().notifyVersionUpgrade(currentVersion, newVersion, !showAlways);
        });
    }
