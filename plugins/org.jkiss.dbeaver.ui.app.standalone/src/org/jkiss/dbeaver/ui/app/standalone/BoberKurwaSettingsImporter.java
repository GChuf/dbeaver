 ...
 */
class BoberKurwaSettingsImporter {
    ...
    private final BoberKurwaApplication application;
    ...
    public BoberKurwaSettingsImporter(BoberKurwaApplication application, Display display) {
    ...
    boolean migrateFromPreviousVersion(final File oldDir, final File newDir) {
        ...
        String oldVersion = workspaceProps.getProperty(BoberKurwaApplication.VERSION_PROP_PRODUCT_VERSION);
        if (oldVersion == null) {
            oldVersion = "3.x";
        } else {
        ...
        Image dbeaverIcon = AbstractUIPlugin.imageDescriptorFromPlugin(BoberKurwaApplication.APPLICATION_PLUGIN_ID, "icons/dbeaver32.png").createImage();
        Image dbeaverLogo = AbstractUIPlugin.imageDescriptorFromPlugin(BoberKurwaApplication.APPLICATION_PLUGIN_ID, "icons/dbeaver64.png").createImage();
    ...
    private void migrateWorkspace(final File oldDir, final File newDir) {
        ...
        new Thread(() -> {
            try {
                ...
                BoberKurwaApplication.WORKSPACE_MIGRATED = true;
