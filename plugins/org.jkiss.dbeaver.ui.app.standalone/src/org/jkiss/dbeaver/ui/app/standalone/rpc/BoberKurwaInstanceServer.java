...
/**
 * BoberKurwa instance controller.
 */
public class BoberKurwaInstanceServer implements IInstanceController {

    private static final Log log = Log.getLog(BoberKurwaInstanceServer.class);
    ...
    private BoberKurwaInstanceServer() throws IOException {
        server = RestServer
        ...
        try (ByteArrayOutputStream os = new ByteArrayOutputStream()) {
            ...
            props.store(os, "BoberKurwa instance server properties");
    ...
    @Nullable
    public static BoberKurwaInstanceServer createServer() throws IOException {
        if (createClient() != null) {
            log.debug("Can't start instance server because other instance is already running");
            return null;
        }

        return new BoberKurwaInstanceServer();
    }
