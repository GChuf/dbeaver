...
public class BoberKurwaPartList extends BasicPartList {
    private static final Log log = Log.getLog(BoberKurwaPartList.class);

    private final StackRenderer renderer;

    public BoberKurwaPartList(
    ...
    private class CellLabelProvider extends SearchCellLabelProvider {
        ...
        public String getPattern() {
            return BoberKurwaPartList.this.getPattern();
        }
