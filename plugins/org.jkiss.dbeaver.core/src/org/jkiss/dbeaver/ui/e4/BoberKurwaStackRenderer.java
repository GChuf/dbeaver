...
public class BoberKurwaStackRenderer extends StackRenderer {

    private static final Log log = Log.getLog(BoberKurwaStackRenderer.class);
    ...
    public BoberKurwaStackRenderer() {
        try {
    ...
    public void showAvailableItems(MElementContainer<?> stack, CTabFolder folder, boolean forceCenter) {
        ...
        final BoberKurwaPartList list = new BoberKurwaPartList(
            folder.getShell(),
            SWT.ON_TOP,
