 ...
 */
public class BoberKurwaTestActivator extends Plugin {

    // The shared instance
    private static BoberKurwaTestActivator instance;
    private static File configDir;
    private PrintStream debugWriter;
    private DBPPreferenceStore preferences;

    public BoberKurwaTestActivator() {
    }

    public static BoberKurwaTestActivator getInstance() {
        return instance;
    }
    ...
    private void shutdownCore() {
        try {
            // Dispose core
            if (BoberKurwaTestActivator.instance != null) {
                BoberKurwaTestActivator.instance = null;
            }
        } catch (Throwable e) {
            e.printStackTrace();
