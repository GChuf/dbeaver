 ...
 */
public class BoberKurwaHeadlessApplication extends DesktopApplicationImpl {

    private static final Log log = Log.getLog(BoberKurwaHeadlessApplication.class);

    public BoberKurwaHeadlessApplication() {
        // Initialize platform
    ...
    public Class<? extends DBPPlatform> getPlatformClass() {
        return BoberKurwaTestPlatform.class;
    }

    @Override
    public Class<? extends DBPPlatformUI> getPlatformUIClass() {
        return BoberKurwaTestPlatformUI.class;
    }

    @Override
    public String getDefaultProjectName() {
        return "BoberKurwaTests";
    }
    ...
    public DBPPreferenceStore getPreferenceStore() {
        return BoberKurwaTestActivator.getInstance().getPreferences();
    }
}
