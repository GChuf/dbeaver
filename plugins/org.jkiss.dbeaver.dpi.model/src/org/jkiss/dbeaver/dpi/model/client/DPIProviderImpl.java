...
public class DPIProviderImpl implements DPIProvider {
    ...
    @Override
    public DPIProcessController detachDatabaseProcess(DBRProgressMonitor monitor, DBPDataSourceContainer dataSourceContainer) throws IOException {
        try {
            BundleProcessConfig processConfig = BundleConfigGenerator.generateBundleConfig(monitor, dataSourceContainer);
            return new DPIProcessControllerImpl(dataSourceContainer, processConfig);
        } catch (Exception e) {
